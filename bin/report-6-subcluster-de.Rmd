...
Differential expression is performed for each cluster in the left cloud,
while excluding all other cluster and cell types from the analysis, as
visualised in the following plot.
...
```{r LC Violinplot, fig.height = 20, fig.width = 20}
...
```{r RC Violinplot, fig.height = 40, fig.width = 20}
