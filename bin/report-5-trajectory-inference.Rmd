...
```{r Subset to RC cells, eval = FALSE}
...
```{r Integrate RC data, eval = FALSE}
# Integrate data
...
```{r Infer RC trajectories, fig.width = 21, eval = FALSE}
curves_RC <- infer_trajectories(s_obj_RC, "seurat_clusters")
```

```{r Plot RC pseudotime, fig.width = 7, eval = FALSE}
plot_pseudotime(s_obj_RC, curves_RC)
```

```{r Fit RC GAM, eval = FALSE}
