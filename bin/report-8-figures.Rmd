...
```{r Read data and rename samples}
# Read data
...
F3a <- ggplot() +
    theme_void() +
    # draw_image("../data/figures/F3a.png")
    draw_image(paste0(params$image_dir, "/F3a.png"))
F3b <- ggplot() +
    theme_void() +
    # draw_image("../data/figures/F3b.png")
    draw_image(paste0(params$image_dir, "/F3b.png"))
F3c <- ggplot() +
    theme_void() +
    # draw_image("../data/figures/F3c.png")
...
features <- c("Hml", "TGA1", "comp30385-c0", "PXN", "VMO1", "Duox",
              "comp33777-c0", "comp18871", "lysoz2", "comp36636-c0",
